export function Contact() {
  return (
    <div>
      <h2 className="uppercase text-xs font-semibold text-gray-400 mb-4">
        FIND ME ON
      </h2>
      <div className="space-y-5">
        <a
          href="https://twitter.com/TinsFox"
          rel="noopener noreferrer"
          target="_blank"
          className="flex items-end gap-4 dark:hover:text-gray-300 group"
        >
          <span className="text-sm">Twitter</span>
          <div className="flex-1 border-b border-dashed border-gray-300 dark:border-gray-800 group-hover:border-gray-700" />
          <svg
            data-v-bd832875=""
        ...
        <a
          href="https://www.linkedin.com/in/TinsFox/"
          rel="noopener noreferrer"
          target="_blank"
          className="flex items-end gap-4 dark:hover:text-gray-300 group"
        >
